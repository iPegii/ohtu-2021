...
public class Stepdefs {
    ...
    public void nonexistentUsernameAndPasswordtringAreGiven(String username, String password) {
        logInWith(username, password);
    }    
    ...
    @When("a valid username {string} and password {string} and password confirmation {string} not matching are entered")
    public void aValidUsernameAndPasswordAndPasswordConfirmationNotMatchingAreEntered(String username, String password, String passwordConfirmation) {
        registerInWithConfirmationIncluded(username, password, passwordConfirmation);
    }
    ...
    private void registerInWith(String username, String password) {
    ...
    private void registerInWithConfirmationIncluded(String username, String password, String passwordConfirmation) {
        assertTrue(driver.getPageSource().contains("Create username and give password"));
        WebElement element = driver.findElement(By.name("username"));
        element.sendKeys(username);
        element = driver.findElement(By.name("password"));
